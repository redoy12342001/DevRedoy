...
const About = () => {
    ...
    return (
        <div className='grid grid-cols-1 xl:grid-cols-2 items-center justify-center mt-10 '>
            {/* text section */}
            <section className=''>
                ...
                <div>
                    ...
                    {/* social box  */}
                    <div className='flex items-center gap-10 md:mt-10 xl:mt-0'>
                        <div className="mt-10 md:mt-0 xl:mt-10 styled-button inline-flex flex-col lg:items-start lg:justify-start gap-5">
                        ...
                        {/* img section hidden at xl device  */}
                        <section className=' hidden md:flex xl:hidden'>
            ...
            {/* img section  */}
            <section className='flex md:hidden xl:flex lg:pl-60 mt-10 lg:mt-0'>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img className='img-shadow' src="/images/aboutme-img.png" alt="" />
            </section>
