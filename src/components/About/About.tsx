    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 items-center justify-center '>
            ...
            <section className='p-10'>
                ...
                <h1 className='mb-5 text-5xl'>Professional <span className='text-primary'>Web Developer</span> For Your Digital Business</h1>
                {/* <MorphingText texts={texts} /> */}
                <p>Hi, I'm a passionate MERN stack developer with a strong enthusiasm for building modern web applications.
